  ...
  "paths": {
    "/pms/folios": {
      "get": {
        ...
        "operationId": "getFoliosCollection",
        "description": "Returns a collection of folios, this endpoint will return all folio types.",
        "parameters": [
          {
            "schema": {
              "type": "integer",
