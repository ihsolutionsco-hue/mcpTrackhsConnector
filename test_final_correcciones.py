...
async def test_correcciones_final():
    print("=== PROBANDO CORRECCIONES IMPLEMENTADAS (FINAL) ===")
    print()
    ...
    try:
        result = await mcp.call_tool_async("search_amenities", {"page": 1, "size": 3})
    ...
    try:
        result = await mcp.call_tool_async("get_folio", {"reservation_id": 1})
...
if __name__ == "__main__":
    asyncio.run(test_correcciones_final())
