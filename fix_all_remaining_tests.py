#!/usr/bin/env python3
"""
Script inteligente para corregir todos los tests restantes
"""
...
def fix_all_remaining_tests():
    """Corrige todos los tests restantes de forma inteligente"""
    print("Corrigiendo todos los tests restantes de forma inteligente...")

    # Archivo 1: tests/e2e/test_search_units_e2e.py
    fix_e2e_tests_intelligent()

    # Archivo 2: tests/integration/test_search_units.py
    fix_integration_tests_intelligent()

    print("\nCorrecciones completadas!")


def fix_e2e_tests_intelligent():
    """Corrige los tests E2E de forma inteligente"""
    ...
    # Patrones inteligentes para tests E2E
    patterns = [
        # Test de amenidades - incluir parámetros por defecto
        (
            r"params=\{'amenityId': \[1, 2, 3\], 'petsFriendly': 1, 'eventsAllowed': 1\}",
            r'params={"page": 0, "size": 25, "sortColumn": "name", "sortDirection": "asc", "amenityId": [1, 2, 3], "petsFriendly": 1, "eventsAllowed": 1}',
        ),
        # Test de ubicación - incluir parámetros por defecto
        (
            r"params=\{'nodeId': \[1, 2, 3\], 'isActive': 1\}",
            r'params={"page": 0, "size": 25, "sortColumn": "name", "sortDirection": "asc", "nodeId": [1, 2, 3], "isActive": 1}',
        ),
...
def fix_integration_tests_intelligent():
    """Corrige los tests de integración de forma inteligente"""
    ...
    # Patrones inteligentes para tests de integración
    patterns = [
