...
def test_api_connection(
    base_url: str, username: str, password: str, endpoint: str = "pms/units"
) -> Dict[str, Any]:
...
def main():
    ...
    if successful_configs:
        ...
        other_results = test_other_endpoints(
            best_config["base_url"], username, password
        )
        ...
        json.dump(
            {
                ...
                "recommendations": {
                    "best_config": (
                        successful_configs[0] if successful_configs else None
                    ),
                    "fastmcp_cloud_config": {
                        "TRACKHS_API_URL": (
                            successful_configs[0]["base_url"]
                            if successful_configs
                            else None
                        ),
