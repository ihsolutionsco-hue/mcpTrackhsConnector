...
def main():
    ...
    diagnosis_scripts = [
        ("scripts/check_fastmcp_cloud_config.py", "Verificación de Configuración FastMCP Cloud"),
    ...
    report_file = f"complete_diagnosis_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
