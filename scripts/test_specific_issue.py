...
def suggest_solutions():
    ...
    print("   - TRACKHS_API_URL es opcional (default: https://ihmvacations.trackhs.com/api)")
...
def main():
    ...
    if success:
        ...
        print("Ejecuta los scripts de diagnóstico para encontrar la configuración correcta.")
