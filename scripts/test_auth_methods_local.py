...
def test_custom_headers_local(
    base_url: str, endpoint: str, username: str, password: str
):
...
def main():
    ...
    if successful_methods:
        ...
        if successful_methods[0] == "Basic Auth":
            ...
            print(
                f"   Podrías necesitar modificar el código para usar headers personalizados"
            )
