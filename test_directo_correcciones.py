#!/usr/bin/env python3
"""
Script de prueba directa para verificar las correcciones implementadas
"""
...
# Importar las funciones directamente del módulo
...
def test_correcciones_directo():
    print("=== PROBANDO CORRECCIONES IMPLEMENTADAS (DIRECTO) ===")
    print()

    # Test 1: search_units con parámetros correctos
    print("1. Probando search_units con parámetros correctos...")
    try:
        # Llamar directamente a la función sin decorador
        result = search_units.func(page=1, size=2, is_active=1, is_bookable=1)
    ...
    try:
        result = search_amenities.func(page=1, size=3)
    ...
    try:
        result = create_maintenance_work_order.func(
            unit_id=75,
    ...
    try:
        result = get_folio.func(reservation_id=1)
