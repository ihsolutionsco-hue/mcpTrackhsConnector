...
class TestMCPIntegrationE2E:
    ...
    async def test_pagination_workflow(self, mock_api_client):
        ...
        page1_response = {
            ...
            "total_items": 2,
            "_links": {
                "self": {"href": "/v2/pms/reservations?page=1&size=1"},
                "next": {"href": "/v2/pms/reservations?page=2&size=1"},
                "last": {"href": "/v2/pms/reservations?page=2&size=1"}
            }
        }
        ...
        page2_response = {
            ...
            "total_items": 2,
            "_links": {
                "self": {"href": "/v2/pms/reservations?page=2&size=1"},
                "prev": {"href": "/v2/pms/reservations?page=1&size=1"},
                "last": {"href": "/v2/pms/reservations?page=2&size=1"}
            }
        }
    ...
    async def test_concurrent_requests(self, mock_api_client, sample_search_response):
        ...
        tasks = [
            tool_func(page=1, size=10, search=f"search_{i}")
            for i in range(5)
        ]
    ...
    async def test_validation_workflow(self, mock_api_client):
        ...
        with pytest.raises(Exception):  # ValidationError
            await tool_func(page=1, size=10, arrival_start="invalid-date")  # Fecha inválida
