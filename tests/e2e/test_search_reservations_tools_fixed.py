"""
Tests E2E corregidos para los dos tools principales: search_reservations_v1 y search_reservations_v2
"""
...
class TestSearchReservationsToolsE2EFixed:
    """Tests E2E corregidos para los tools de búsqueda de reservas V1 y V2"""
