...
class TestResourcesIntegration:
    ...
    def test_resource_registration_count(self, mock_mcp, mock_api_client):
        ...
        assert len(set(resource_names)) == len(resource_names), "Resource names should be unique"
    ...
    def test_resource_names(self, mock_mcp, mock_api_client):
        ...
        for expected_name in expected_names:
            assert expected_name in resource_names, f"Resource {expected_name} should be registered"
