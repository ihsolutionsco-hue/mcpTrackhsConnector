...
from src.trackhs_mcp.domain.exceptions.api_exceptions import ValidationError as APIValidationError
...
class TestSearchReservationsV2:
    ...
    async def test_basic_search(self):
        ...
        with patch('src.trackhs_mcp.infrastructure.mcp.search_reservations_v2.SearchReservationsUseCase') as mock_use_case:
    ...
    async def test_total_results_validation(self):
        ...
        with pytest.raises(APIValidationError):
            await search_reservations_v2(
                page=1000,  # Página que excede límite
                size=10
            )
