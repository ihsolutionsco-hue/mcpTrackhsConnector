"""
Test simple para mejorar la cobertura de código importando el código fuente
"""
...
# Importar el código fuente para mejorar cobertura
...
class TestSimpleCoverage:
    """Tests simples para mejorar la cobertura de código"""
    ...
    def test_error_handler(self):
        ...
        assert result is None  # ErrorHandler.handle_error retorna None
    ...
    def test_user_friendly_messages(self):
        ...
        type_msg = format_type_error("Invalid type", "int", "string")
        ...
        boolean_msg = format_boolean_error("Invalid boolean", "true")
        assert isinstance(boolean_msg, str)

        # Test format_id_list_error
        id_list_msg = format_id_list_error("Invalid ID list", "invalid")
