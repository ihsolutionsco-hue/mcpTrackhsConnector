...
from src.trackhs_mcp.core.logging import (
    LogLevel, LogCategory, LogContext, LogMetric, TrackHSLogger,
    RequestContext, PerformanceTimer, get_logger
)
...
class TestTrackHSLogger:
    ...
    def test_log_tool_execution(self, logger):
        ...
        with patch.object(logger.logger, 'log') as mock_log:
            logger.log_tool_execution("search_reservations", {"page": 1}, {"result": "success"})
...
class TestRequestContext:
    ...
    def test_request_context_with_user_id(self):
        ...
        with patch('src.trackhs_mcp.core.logging.request_id_var') as mock_request_var, \
