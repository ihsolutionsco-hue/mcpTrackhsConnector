#!/usr/bin/env python3
"""
Script de prueba para verificar las correcciones implementadas usando MCP
"""
...
async def test_correcciones_mcp():
    print("=== PROBANDO CORRECCIONES IMPLEMENTADAS CON MCP ===")
    print()
    ...
    try:
        result = await mcp.call_tool(
            "search_units", {"page": 1, "size": 2, "is_active": 1, "is_bookable": 1}
        )
    ...
    try:
        result = await mcp.call_tool("search_amenities", {"page": 1, "size": 3})
...
if __name__ == "__main__":
    asyncio.run(test_correcciones_mcp())
