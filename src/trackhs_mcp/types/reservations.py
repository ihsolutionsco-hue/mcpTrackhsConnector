...
class SecurityDeposit(BaseModel):
    ...
    required: str = Field(..., description="Monto total requerido del depósito de seguridad")
    remaining: float = Field(..., description="Monto restante del depósito de seguridad")
...
class Reservation(BaseModel):
    ...
    alternates: Optional[List[str]] = Field(default=None, description="IDs de confirmación alternativos")
    currency: str = Field(..., description="Moneda de la reserva")
    unit_id: int = Field(..., description="ID de la unidad")
    client_ip_address: Optional[str] = Field(default=None, description="Dirección IP del cliente")
    session: Optional[str] = Field(default=None, description="Datos de sesión para detección de fraude")
    ...
    status: Literal["Hold", "Confirmed", "Checked Out", "Checked In", "Cancelled"] = Field(..., description="Estado de la reserva")
    cancelled_at: Optional[str] = Field(default=None, description="Fecha de cancelación (ISO 8601)")
    ...
    owner_breakdown: Optional[OwnerBreakdown] = Field(default=None, description="Desglose del propietario")
    discount_reason_id: Optional[int] = Field(default=None, description="ID de la razón del descuento")
    discount_notes: Optional[str] = Field(default=None, description="Notas del descuento")
    ...
    guarantee_policy_id: Optional[int] = Field(default=None, description="ID de la política de garantía")
    cancellation_policy_id: Optional[int] = Field(default=None, description="ID de la política de cancelación")
    cancellation_reason_id: Optional[int] = Field(default=None, description="ID de la razón de cancelación")
    ...
    unit_code_id: Optional[int] = Field(default=None, description="ID del código de unidad")
    cancelled_by_id: Optional[int] = Field(default=None, description="ID de quien canceló")
    payment_method_id: Optional[int] = Field(default=None, description="ID del método de pago")
    quote_id: Optional[int] = Field(default=None, description="ID de la cotización")
    hold_expires_at: Optional[str] = Field(default=None, description="Fecha de expiración de la retención")
    is_taxable: bool = Field(..., description="Si es gravable")
    invite_uuid: Optional[str] = Field(default=None, description="UUID de la invitación")
    ...
    agreement_status: Literal["not-needed", "not-sent", "sent", "viewed", "received"] = Field(..., description="Estado del acuerdo")
    automate_payment: bool = Field(..., description="Si el pago es automático")
    revenue_realized_method: str = Field(..., description="Método de realización de ingresos")
    schedule_type1: Optional[str] = Field(default=None, description="Tipo de programación 1")
    schedule_percentage1: Optional[float] = Field(default=None, description="Porcentaje de programación 1")
    schedule_type2: Optional[str] = Field(default=None, description="Tipo de programación 2")
    schedule_percentage2: Optional[float] = Field(default=None, description="Porcentaje de programación 2")
    promo_code_id: Optional[int] = Field(default=None, description="ID del código promocional")
...
class SearchReservationsParams(PaginationParams, SearchParams):
    ...
    node_id: Optional[Union[int, List[int]]] = Field(default=None, description="ID(s) del nodo específico")
    unit_id: Optional[Union[int, List[int]]] = Field(default=None, description="ID(s) de la unidad específica")
    reservation_type_id: Optional[Union[int, List[int]]] = Field(default=None, description="ID(s) del tipo de reserva específico")
    contact_id: Optional[Union[int, List[int]]] = Field(default=None, description="ID(s) del contacto específico")
    travel_agent_id: Optional[Union[int, List[int]]] = Field(default=None, description="ID(s) del agente de viajes específico")
    campaign_id: Optional[Union[int, List[int]]] = Field(default=None, description="ID(s) de la campaña específica")
    user_id: Optional[Union[int, List[int]]] = Field(default=None, description="ID(s) del usuario específico")
    unit_type_id: Optional[Union[int, List[int]]] = Field(default=None, description="ID(s) del tipo de unidad específico")
    rate_type_id: Optional[Union[int, List[int]]] = Field(default=None, description="ID(s) del tipo de tarifa específico")
    booked_start: Optional[str] = Field(default=None, description="Fecha de inicio de reserva (ISO 8601)")
    booked_end: Optional[str] = Field(default=None, description="Fecha de fin de reserva (ISO 8601)")
    arrival_start: Optional[str] = Field(default=None, description="Fecha de inicio de llegada (ISO 8601)")
    arrival_end: Optional[str] = Field(default=None, description="Fecha de fin de llegada (ISO 8601)")
    departure_start: Optional[str] = Field(default=None, description="Fecha de inicio de salida (ISO 8601)")
    departure_end: Optional[str] = Field(default=None, description="Fecha de fin de salida (ISO 8601)")
    updated_since: Optional[str] = Field(default=None, description="Fecha de actualización desde (ISO 8601)")
    scroll: Optional[Union[int, str]] = Field(default=None, description="Scroll de Elasticsearch (1 para empezar, string para continuar)")
    in_house_today: Optional[Literal[0, 1]] = Field(default=None, description="Filtrar por en casa hoy")
    status: Optional[Union[Literal["Hold", "Confirmed", "Checked Out", "Checked In", "Cancelled"], List[str]]] = Field(default=None, description="Estado(s) de la reserva")
