...
class WorkOrderEmbedded(BaseModel):
    ...
    unit: Optional[Dict[str, Union[int, str]]] = Field(default=None, description="Unidad")
    vendor: Optional[Dict[str, Union[int, str]]] = Field(default=None, description="Vendor")
    owner: Optional[Dict[str, Union[int, str]]] = Field(default=None, description="Propietario")
...
class MaintenanceWorkOrder(BaseModel):
    ...
    priority: Literal[5, 3, 1] = Field(..., description="Prioridad (High=5, Medium=3, Low=1)")
    status: Literal["open", "not-started", "in-progress", "completed", "processed", 
                   "vendor-not-start", "vendor-assigned", "vendor-declined", 
                   "vendor-completed", "user-completed", "cancelled"] = Field(..., description="Estado")
    ...
    date_completed: Optional[str] = Field(default=None, description="Fecha de completado")
    completed_by_id: Optional[int] = Field(default=None, description="ID de quien completó")
    date_processed: Optional[str] = Field(default=None, description="Fecha de procesado")
    processed_by_id: Optional[int] = Field(default=None, description="ID de quien procesó")
    ...
    reference_number: Optional[str] = Field(default=None, description="Número de referencia")
    ...
    source_phone: Optional[str] = Field(default=None, description="Teléfono de la fuente")
    block_checkin: Optional[bool] = Field(default=None, description="Si bloquea check-in")
...
class GetMaintenanceWorkOrdersParams(PaginationParams, SearchParams):
    ...
    sort_column: Optional[Literal["id", "scheduledAt", "status", "priority", "dateReceived", 
                                 "unitId", "vendorId", "userId", "summary"]] = Field(default="id", description="Columna para ordenar")
    sort_direction: Optional[Literal["asc", "desc"]] = Field(default="asc", description="Dirección de ordenamiento")
    is_scheduled: Optional[Literal[0, 1]] = Field(default=None, description="Si está programado")
    ...
    reservation_id: Optional[int] = Field(default=None, description="ID de la reserva")
    vendor_id: Optional[int] = Field(default=None, description="ID del vendor")
    status: Optional[List[Literal["open", "not-started", "in-progress", "completed", "processed", 
                                 "vendor-not-start", "vendor-assigned", "vendor-declined", 
                                 "vendor-completed", "user-completed", "cancelled"]]] = Field(default=None, description="Estados")
