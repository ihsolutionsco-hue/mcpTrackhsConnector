...
class FolioCompany(BaseModel):
    ...
    type: Literal["company", "agent", "vendor", "owner"] = Field(..., description="Tipo de empresa")
...
class FolioRule(BaseModel):
    ...
    breakdown_rent_mode: Optional[Literal["percent", "nights"]] = Field(default=None, description="Modo de desglose de renta")
    breakdown_rent_include_tax: Optional[bool] = Field(default=None, description="Si incluir impuestos en desglose de renta")
    breakdown_rent_percent: Optional[int] = Field(default=None, description="Porcentaje de desglose de renta")
    breakdown_rent_nights: Optional[int] = Field(default=None, description="Noches de desglose de renta")
    breakdown_fee_mode: Optional[Literal["percent", "required"]] = Field(default=None, description="Modo de desglose de tarifas")
    breakdown_fee_include_tax: Optional[bool] = Field(default=None, description="Si incluir impuestos en desglose de tarifas")
...
class Folio(BaseModel):
    ...
    master_folio_rule_id: Optional[int] = Field(default=None, description="ID de la regla maestra del folio")
    master_folio_id: Optional[int] = Field(default=None, description="ID del folio maestro")
    agent_commission: Optional[int] = Field(default=None, description="Comisión del agente")
    owner_commission: Optional[int] = Field(default=None, description="Comisión del propietario")
    owner_revenue: Optional[int] = Field(default=None, description="Ingresos del propietario")
    check_out_date: Optional[str] = Field(default=None, description="Fecha de check-out")
    check_in_date: Optional[str] = Field(default=None, description="Fecha de check-in")
    exception_message: Optional[str] = Field(default=None, description="Mensaje de excepción")
    has_exception: Optional[bool] = Field(default=None, description="Si tiene excepción")
...
class GetFoliosCollectionParams(PaginationParams, SearchParams):
    ...
    sort_column: Optional[Literal["id", "name", "status", "type", "startDate", "endDate", "contactName", "companyName", "reservationId", "currentBalance", "realizedBalance", "masterFolioRule"]] = Field(default="id", description="Columna para ordenar")
    sort_direction: Optional[Literal["asc", "desc"]] = Field(default="asc", description="Dirección de ordenamiento")
    type: Optional[Literal["guest", "master", "guest-sub-folio", "master-sub-folio"]] = Field(default=None, description="Tipo de folio")
    status: Optional[Literal["open", "closed"]] = Field(default=None, description="Estado del folio")
    master_folio_id: Optional[int] = Field(default=None, description="ID del folio maestro")
