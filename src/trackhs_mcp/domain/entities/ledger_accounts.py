...
class Stakeholder(BaseModel):
    ...
    type: Literal["company", "agent", "vendor", "owner"] = Field(
        ..., description="Tipo de stakeholder"
    )
    ...
    links: Optional[StakeholderLinks] = Field(
...
class LedgerAccount(BaseModel):
    ...
    category: Literal["revenue", "asset", "equity", "expense", "liability"] = Field(
        ..., description="Categoría"
    )
    account_type: Literal["bank", "current", "fixed", "other-asset", "receivable"] = (
        Field(..., description="Tipo de cuenta")
    )
    ...
    allow_owner_payments: bool = Field(
        ..., description="Si permite pagos de propietarios"
    )
    ...
    recursive_balance: Optional[int] = Field(
        default=None, description="Balance recursivo"
    )
    immediate_destination: Optional[int] = Field(
        default=None, description="Destino inmediato"
    )
    immediate_destination_name: Optional[str] = Field(
        default=None, description="Nombre del destino inmediato"
    )
    immediate_origin_name: Optional[str] = Field(
        default=None, description="Nombre del origen inmediato"
    )
    company_name: Optional[str] = Field(
        default=None, description="Nombre de la empresa"
    )
    company_identification: Optional[int] = Field(
        default=None, description="Identificación de la empresa"
    )
    stakeholder_id: Optional[int] = Field(
        default=None, description="ID del stakeholder"
    )
    enable_refunds: bool = Field(..., description="Si habilitar reembolsos")
    default_refund_account: Optional[int] = Field(
        default=None, description="Cuenta de reembolso por defecto"
    )
    created_by: str = Field(..., description="Creado por")
    created_at: str = Field(..., description="Fecha de creación")
    updated_by: str = Field(..., description="Actualizado por")
    updated_at: str = Field(..., description="Fecha de actualización")
    embedded: Optional[Dict[str, Union["LedgerAccount", Stakeholder]]] = Field(
        default=None, alias="_embedded", description="Datos embebidos"
    )
    links: Optional[LedgerAccountLinks] = Field(
        default=None, alias="_links", description="Enlaces"
    )
...
class GetLedgerAccountsParams(PaginationParams, SearchParams):
    ...
    sort_column: Optional[
        Literal["id", "name", "type", "relativeOrder", "isActive"]
    ...
    category: Optional[
        Literal["Revenue", "Asset", "Equity", "Liability", "Expense"]
    ] = Field(default=None, description="Categoría")
    account_type: Optional[str] = Field(default=None, description="Tipo de cuenta")
    parent_id: Optional[int] = Field(default=None, description="ID de la cuenta padre")
    include_restricted: Optional[int] = Field(
        default=None, description="Si incluir restringidas"
    )
    sort_by_category_value: Optional[int] = Field(
        default=None, description="Ordenar por valor de categoría"
    )
...
class LedgerAccountsResponse(BaseModel):
    ...
    embedded: Dict[str, List[LedgerAccount]] = Field(
