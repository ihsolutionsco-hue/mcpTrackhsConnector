    ...
    async def reservations_schema() -> Dict[str, Any]:
        ...
        return {
            "schema": {
                ...
                "alternates": {"type": "array", "items": {"type": "string"}, "description": "IDs de confirmación alternativos"},
                "currency": {"type": "string", "description": "Moneda de la reserva"},
                "unit_id": {"type": "integer", "description": "ID de la unidad"},
                "is_unit_locked": {"type": "boolean", "description": "Si la unidad está bloqueada"},
                "is_unit_assigned": {"type": "boolean", "description": "Si la unidad está asignada"},
                "is_unit_type_locked": {"type": "boolean", "description": "Si el tipo de unidad está bloqueado"},
                "unit_type_id": {"type": "integer", "description": "ID del tipo de unidad"},
                "arrival_date": {"type": "string", "format": "date", "description": "Fecha de llegada (ISO 8601)"},
                "departure_date": {"type": "string", "format": "date", "description": "Fecha de salida (ISO 8601)"},
                "early_arrival": {"type": "boolean", "description": "Llegada temprana"},
                "late_departure": {"type": "boolean", "description": "Salida tardía"},
                "arrival_time": {"type": "string", "format": "date-time", "description": "Hora de llegada (ISO 8601)"},
                "departure_time": {"type": "string", "format": "date-time", "description": "Hora de salida (ISO 8601)"},
                "nights": {"type": "number", "description": "Número de noches"},
                "status": {"type": "string", "enum": ["Hold", "Confirmed", "Checked Out", "Checked In", "Cancelled"], "description": "Estado de la reserva"},
                "cancelled_at": {"type": "string", "format": "date-time", "nullable": True, "description": "Fecha de cancelación (ISO 8601)"},
                "occupants": {"type": "array", "items": {"$ref": "#/definitions/Occupant"}, "description": "Ocupantes"},
                "security_deposit": {"$ref": "#/definitions/SecurityDeposit", "description": "Depósito de seguridad"},
                "updated_at": {"type": "string", "format": "date-time", "description": "Fecha de actualización (ISO 8601)"},
                "created_at": {"type": "string", "format": "date-time", "description": "Fecha de creación (ISO 8601)"},
                "booked_at": {"type": "string", "format": "date-time", "description": "Fecha de reserva (ISO 8601)"},
                "guest_breakdown": {"$ref": "#/definitions/GuestBreakdown", "description": "Desglose del huésped"},
                "owner_breakdown": {"$ref": "#/definitions/OwnerBreakdown", "description": "Desglose del propietario"},
                "contact_id": {"type": "integer", "description": "ID del contacto"},
                "channel_id": {"type": "integer", "description": "ID del canal"},
                "sub_channel": {"type": "string", "nullable": True, "description": "Subcanal"},
                "folio_id": {"type": "integer", "description": "ID del folio"},
                "guarantee_policy_id": {"type": "integer", "nullable": True, "description": "ID de la política de garantía"},
                "cancellation_policy_id": {"type": "integer", "nullable": True, "description": "ID de la política de cancelación"},
                "cancellation_reason_id": {"type": "integer", "nullable": True, "description": "ID de la razón de cancelación"},
                "user_id": {"type": "integer", "description": "ID del usuario"},
                "travel_agent_id": {"type": "integer", "nullable": True, "description": "ID del agente de viajes"},
                "campaign_id": {"type": "integer", "nullable": True, "description": "ID de la campaña"},
                "type_id": {"type": "integer", "description": "ID del tipo"},
                "rate_type_id": {"type": "integer", "description": "ID del tipo de tarifa"},
                "unit_code_id": {"type": "integer", "nullable": True, "description": "ID del código de unidad"},
                "cancelled_by_id": {"type": "integer", "nullable": True, "description": "ID de quien canceló"},
                "payment_method_id": {"type": "integer", "nullable": True, "description": "ID del método de pago"},
                "quote_id": {"type": "integer", "nullable": True, "description": "ID de la cotización"},
                "hold_expires_at": {"type": "string", "format": "date-time", "nullable": True, "description": "Fecha de expiración de la retención"},
                "is_taxable": {"type": "boolean", "description": "Si es gravable"},
                "invite_uuid": {"type": "string", "nullable": True, "description": "UUID de la invitación"},
                "uuid": {"type": "string", "description": "UUID de la reserva"},
                "source": {"type": "string", "description": "Fuente de la reserva"},
                "is_channel_locked": {"type": "boolean", "description": "Si el canal está bloqueado"},
                "agreement_status": {"type": "string", "enum": ["not-needed", "not-sent", "sent", "viewed", "received"], "description": "Estado del acuerdo"},
                "automate_payment": {"type": "boolean", "description": "Si el pago es automático"},
                "revenue_realized_method": {"type": "string", "description": "Método de realización de ingresos"},
                "schedule_type1": {"type": "string", "nullable": True, "description": "Tipo de programación 1"},
                "schedule_percentage1": {"type": "number", "nullable": True, "description": "Porcentaje de programación 1"},
                "schedule_type2": {"type": "string", "nullable": True, "description": "Tipo de programación 2"},
                "schedule_percentage2": {"type": "number", "nullable": True, "description": "Porcentaje de programación 2"},
                "promo_code_id": {"type": "integer", "nullable": True, "description": "ID del código promocional"},
                "updated_by": {"type": "string", "description": "Actualizado por"},
                "created_by": {"type": "string", "description": "Creado por"},
                "group_id": {"type": "integer", "nullable": True, "description": "ID del grupo"},
                "payment_plan": {"type": "array", "items": {"$ref": "#/definitions/PaymentPlan"}, "description": "Plan de pagos"},
                "travel_insurance_products": {"type": "array", "items": {"$ref": "#/definitions/TravelInsuranceProduct"}, "description": "Productos de seguro de viaje"},
            ...
            "definitions": {
                "Occupant": {
                    "type": "object",
                    "properties": {
                        "type_id": {"type": "integer", "description": "ID del tipo de ocupante"},
                        "name": {"type": "string", "description": "Nombre del ocupante"},
                        "handle": {"type": "string", "description": "Handle del ocupante"},
                        "quantity": {"type": "number", "description": "Cantidad"},
                        "included": {"type": "boolean", "description": "Si está incluido en el precio de renta"},
                        "extra_quantity": {"type": "number", "description": "Cantidad extra permitida"},
                        "rate_per_person_per_stay": {"type": "string", "description": "Tarifa por persona por estadía"},
                        "rate_per_stay": {"type": "string", "description": "Tarifa por estadía"}
                    }
                },
                "SecurityDeposit": {
                    "type": "object",
                    "properties": {
                        "required": {"type": "string", "description": "Monto total requerido del depósito de seguridad"},
                        "remaining": {"type": "number", "description": "Monto restante del depósito de seguridad"}
                    }
                },
                "GuestBreakdown": {
                    "type": "object",
                    "properties": {
                        ...
                        "guest_gross_display_rent": {"type": "string", "description": "Renta bruta mostrada al huésped"},
                        "discount": {"type": "string", "description": "Descuento"},
                        "promo_value": {"type": "string", "description": "Valor promocional"},
                        "discount_total": {"type": "number", "description": "Total de descuentos"},
                        "net_rent": {"type": "string", "description": "Renta neta"},
                        "guest_net_display_rent": {"type": "string", "description": "Renta neta mostrada al huésped"},
                        "actual_adr": {"type": "string", "description": "ADR actual"},
                        "guest_adr": {"type": "string", "description": "ADR del huésped"},
                        "total_guest_fees": {"type": "string", "description": "Total de tarifas del huésped"},
                        "total_rent_fees": {"type": "string", "description": "Total de tarifas de renta"},
                        "total_itemized_fees": {"type": "string", "description": "Total de tarifas detalladas"},
                        "total_tax_fees": {"type": "string", "description": "Total de tarifas de impuestos"},
                        "total_service_fees": {"type": "string", "description": "Total de tarifas de servicio"},
                        "folio_charges": {"type": "string", "description": "Cargos del folio"},
                        "subtotal": {"type": "string", "description": "Subtotal"},
                        "guest_subtotal": {"type": "string", "description": "Subtotal del huésped"},
                        "total_taxes": {"type": "string", "description": "Total de impuestos"},
                        "total_guest_taxes": {"type": "string", "description": "Total de impuestos del huésped"},
                        "total": {"type": "string", "description": "Total"},
                        "grand_total": {"type": "string", "description": "Gran total"},
                        "net_payments": {"type": "string", "description": "Pagos netos"},
                        "payments": {"type": "string", "description": "Pagos"},
                        "refunds": {"type": "string", "description": "Reembolsos"},
                        "net_transfers": {"type": "string", "description": "Transferencias netas"},
                        "balance": {"type": "string", "description": "Balance"},
                        "rates": {"type": "array", "items": {"$ref": "#/definitions/Rate"}, "description": "Tarifas"},
                        "guest_fees": {"type": "array", "items": {"$ref": "#/definitions/GuestFee"}, "description": "Tarifas del huésped"},
                        "taxes": {"type": "array", "items": {"$ref": "#/definitions/Tax"}, "description": "Impuestos"}
                    }
                },
                "OwnerBreakdown": {
                    "type": "object",
                    "properties": {
                        "gross_rent": {"type": "string", "description": "Renta bruta del propietario"},
                        "fee_revenue": {"type": "string", "description": "Ingresos por tarifas"},
                        "gross_revenue": {"type": "string", "description": "Ingresos brutos"},
                        "manager_commission": {"type": "string", "description": "Comisión del manager"},
                        "agent_commission": {"type": "string", "description": "Comisión del agente"},
                        "net_revenue": {"type": "string", "description": "Ingresos netos"},
                        "owner_fees": {"type": "array", "items": {"$ref": "#/definitions/OwnerFee"}, "description": "Tarifas del propietario"}
                    }
                },
                "Rate": {
                    "type": "object",
                    "properties": {
                        ...
                        "is_quoted": {"type": "boolean", "description": "Si está cotizada"}
                    }
                },
                "GuestFee": {
                    "type": "object",
                    "properties": {
                        ...
                        "name": {"type": "string", "description": "Nombre de la tarifa"},
                        "display_as": {"type": "string", "enum": ["itemize", "rent", "tax", "service"], "description": "Cómo mostrar"},
                        "quantity": {"type": "string", "description": "Cantidad"},
                        "unit_value": {"type": "string", "description": "Valor unitario"},
                ...
                "Tax": {
                    ...
                    "properties": {
                        ...
                        "amount": {"type": "string", "description": "Monto del impuesto"}
                    }
                },
                "OwnerFee": {
                    "type": "object",
                ...
                "TravelInsuranceProduct": {
                    ...
                    "properties": {
                        ...
                        "status": {"type": "string", "enum": ["optin", "funded", "cancelled"], "description": "Estado"},
                        "type": {"type": "string", "enum": ["Travel Insurance", "Master Cancel", "Damage Deposit"], "description": "Tipo"},
            ...
            "filtering": {
                "supported_parameters": [
                    "search", "tags", "nodeId", "unitId", "reservationTypeId",
                    "contactId", "travelAgentId", "campaignId", "userId",
                    "unitTypeId", "rateTypeId", "bookedStart", "bookedEnd",
                    "arrivalStart", "arrivalEnd", "departureStart", "departureEnd",
                    "updatedSince", "scroll", "inHouseToday", "status",
...
### Ordenamiento
- **Columnas disponibles**: name, status, altConf, agreementStatus, type, guest, guests, unit, units, checkin, checkout, nights
                    ...
                    "search": {
                        ...
                        "parameters": {
                            ...
                            "filtering": [
                                ...
                                "unitTypeId", "rateTypeId", "bookedStart", "bookedEnd",
                                "arrivalStart", "arrivalEnd", "departureStart", "departureEnd",
                                "updatedSince", "inHouseToday", "status", "groupId", "checkinOfficeId"
                            ]
                        },
    ...
    async def api_v2_parameters() -> Dict[str, Any]:
        ...
        return {
            ...
            "filtering": {
                ...
                "tags": {
                    "type": "string",
                    "description": "Búsqueda por ID de tag"
                },
                "nodeId": {
                    "type": "integer|array",
