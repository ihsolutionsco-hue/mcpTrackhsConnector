...
class TrackHSLogger:
    ...
    def _format_message(
        self, message: str, context: LogContext, category: LogCategory, level: LogLevel
    ) -> Dict[str, Any]:
    ...
    def log(
        ...
        level: LogLevel,
        message: str,
        category: LogCategory = LogCategory.MCP_TOOL,
    ...
    def log_tool_execution(
        self, tool_name: str, params: Dict[str, Any], duration_ms: float, success: bool
    ):
    ...
    def log_resource_access(
        self, resource_uri: str, access_type: str, duration_ms: float = None
    ):
    ...
    def log_prompt_usage(
        self, prompt_name: str, args: Dict[str, Any], duration_ms: float = None
    ):
    ...
    def log_authentication(self, user_id: str, success: bool, method: str = None):
        ...
        context = LogContext(
            user_id=user_id, additional_data={"success": success, "method": method}
        )
    ...
    def log_performance(
        self, operation: str, duration_ms: float, metrics: Dict[str, Any] = None
    ):
        """Log de rendimiento"""
        context = LogContext(
            duration_ms=duration_ms,
    ...
    def log_security(self, event: str, details: Dict[str, Any] = None):
        """Log de seguridad"""
        context = LogContext(additional_data={"event": event, "details": details})
        self.log(
            LogLevel.WARNING, f"Security event: {event}", LogCategory.SECURITY, context
        )
...
def log_api_call(
    logger: TrackHSLogger, method: str, endpoint: str, params: Dict[str, Any] = None
):
