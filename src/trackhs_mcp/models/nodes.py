...
class NodeType(BaseModel):
    ...
    is_reservations: Optional[bool] = Field(default=None, description="Si es reservaciones")
    is_housekeeping: Optional[bool] = Field(default=None, description="Si es limpieza")
    is_maintenance: Optional[bool] = Field(default=None, description="Si es mantenimiento")
...
class TaxDistrict(BaseModel):
    ...
    short_term_policy_id: Optional[int] = Field(default=None, description="ID de política de corto plazo")
    long_term_policy_id: Optional[int] = Field(default=None, description="ID de política de largo plazo")
    has_breakpoint: Optional[bool] = Field(default=None, description="Si tiene punto de quiebre")
    breakpoint: Optional[int] = Field(default=None, description="Punto de quiebre")
    sales_tax_policy_id: Optional[int] = Field(default=None, description="ID de política de impuesto de ventas")
    sales_tax_policy: Optional[Any] = Field(default=None, description="Política de impuesto de ventas")
...
class CancellationPolicy(BaseModel):
    ...
    can_exceed_balance: Optional[bool] = Field(default=None, description="Si puede exceder balance")
    cancel_time: Optional[str] = Field(default=None, description="Tiempo de cancelación")
    cancel_timezone: Optional[str] = Field(default=None, description="Zona horaria de cancelación")
...
class Node(BaseModel):
    ...
    housekeeping_notes: Optional[str] = Field(default=None, description="Notas de limpieza")
    ...
    has_early_checkin: Optional[bool] = Field(default=None, description="Si tiene check-in temprano")
    has_late_checkout: Optional[bool] = Field(default=None, description="Si tiene check-out tardío")
    quick_checkin: Optional[bool] = Field(default=None, description="Si tiene check-in rápido")
    quick_checkout: Optional[bool] = Field(default=None, description="Si tiene check-out rápido")
    ...
    tax_district_id: Optional[int] = Field(default=None, description="ID del distrito fiscal")
    tax_district: Optional[TaxDistrict] = Field(default=None, description="Distrito fiscal")
    checkin_office_id: Optional[int] = Field(default=None, description="ID de la oficina de check-in")
    checkin_office: Optional[Any] = Field(default=None, description="Oficina de check-in")
    cancellation_policy_id: Optional[int] = Field(default=None, description="ID de la política de cancelación")
    cancellation_policy: Optional[CancellationPolicy] = Field(default=None, description="Política de cancelación")
    housekeeping_zone_id: Optional[int] = Field(default=None, description="ID de la zona de limpieza")
    housekeeping_zone: Optional[HousekeepingZone] = Field(default=None, description="Zona de limpieza")
    maintenance_zone_id: Optional[int] = Field(default=None, description="ID de la zona de mantenimiento")
    maintenance_zone: Optional[MaintenanceZone] = Field(default=None, description="Zona de mantenimiento")
    is_reservations: Optional[bool] = Field(default=None, description="Si es reservaciones")
    is_housekeeping: Optional[bool] = Field(default=None, description="Si es limpieza")
    is_maintenance: Optional[bool] = Field(default=None, description="Si es mantenimiento")
    is_online: Optional[bool] = Field(default=None, description="Si está en línea")
    ...
    guarantee_policies_ids: Optional[List[int]] = Field(default=None, description="IDs de políticas de garantía")
...
class GetNodesParams(PaginationParams, SearchParams):
    ...
    sort_column: Optional[Literal["id", "name"]] = Field(default="id", description="Columna para ordenar")
