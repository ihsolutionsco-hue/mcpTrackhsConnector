...
class UnitEmbedded(BaseModel):
    ...
    unit_type: Optional[Dict[str, Any]] = Field(default=None, description="Tipo de unidad")
    lodging_type: Optional[Dict[str, Any]] = Field(default=None, description="Tipo de alojamiento")
    ...
    min_booking_window: Optional[int] = Field(default=None, description="Ventana mínima de reserva")
    max_booking_window: Optional[int] = Field(default=None, description="Ventana máxima de reserva")
    ...
    bed_types: Optional[List[Dict[str, Any]]] = Field(default=None, description="Tipos de cama")
    rooms: Optional[List[Dict[str, Any]]] = Field(default=None, description="Habitaciones")
    amenities: Optional[List[Dict[str, Any]]] = Field(default=None, description="Amenidades")
    ...
    local_office: Optional[Dict[str, Any]] = Field(default=None, description="Oficina local")
    regulations: Optional[List[Dict[str, Any]]] = Field(default=None, description="Regulaciones")
    updated: Optional[Dict[str, str]] = Field(default=None, description="Actualizaciones")
...
class ContactEmbedded(BaseModel):
    ...
    is_blacklist: Optional[bool] = Field(default=None, description="Está en lista negra")
    ...
    references: Optional[List[Dict[str, Any]]] = Field(default=None, description="Referencias")
    custom: Optional[Dict[str, Any]] = Field(default=None, description="Campos personalizados")
...
class GuaranteePolicyEmbedded(BaseModel):
    ...
    before_arrival_start: Optional[int] = Field(default=None, description="Inicio antes de llegada")
    before_arrival_end: Optional[int] = Field(default=None, description="Fin antes de llegada")
    ...
    travel_insurance_with_first_payment: bool = Field(..., description="Seguro con primer pago")
    ...
    breakpoints: Optional[List[Dict[str, Any]]] = Field(default=None, description="Puntos de quiebre")
    links: Optional[Dict[str, Dict[str, str]]] = Field(default=None, alias="_links", description="Enlaces")
...
class CancellationPolicyEmbedded(BaseModel):
    ...
    post_date: Literal["now", "checkin", "checkout"] = Field(..., description="Fecha de publicación")
    ...
    tripadvisor_type: Optional[str] = Field(default=None, description="Tipo TripAdvisor")
    ...
    date_group_id: Optional[int] = Field(default=None, description="ID del grupo de fecha")
    date_range_type: Optional[str] = Field(default=None, description="Tipo de rango de fecha")
...
class ReservationTypeEmbedded(BaseModel):
    ...
    charge_rates: Optional[bool] = Field(default=None, description="Cobrar tarifas", deprecated=True)
    charge_rent: Literal["owner", "guest", "none"] = Field(..., description="Cobrar renta")
    rent_earned: Literal["owner", "account", "auto"] = Field(..., description="Renta ganada")
    requires_agreement: bool = Field(..., description="Requiere acuerdo")
    require_payment: bool = Field(..., description="Requiere pago")
    cleaning_options_id: Optional[int] = Field(default=None, description="ID de opciones de limpieza")
    realize_rates: Literal["nightly", "checkin", "checkout", "monthly"] = Field(..., description="Realizar tarifas")
    is_locked: bool = Field(..., description="Está bloqueado")
    send_portal_invited: bool = Field(..., description="Enviar invitación al portal")
    portal_reservation_breakdown: bool = Field(..., description="Desglose de reserva en portal")
    show_folio_transactions: bool = Field(..., description="Mostrar transacciones del folio")
    is_owner: bool = Field(..., description="Es propietario")
    schedule_type1: Optional[str] = Field(default=None, description="Tipo de programación 1")
    schedule_percentage1: Optional[int] = Field(default=None, description="Porcentaje de programación 1")
    schedule_type2: Optional[str] = Field(default=None, description="Tipo de programación 2")
    schedule_percentage2: Optional[int] = Field(default=None, description="Porcentaje de programación 2")
    ...
    security_deposit_type: Optional[str] = Field(default=None, description="Tipo de depósito de seguridad")
    defer_disbursement: bool = Field(..., description="Diferir desembolso")
    defer_disbursement_date: Optional[str] = Field(default=None, description="Fecha de desembolso diferido")
    pos_default_allow: bool = Field(..., description="Permitir POS por defecto")
    pos_default_limit: Optional[str] = Field(default=None, description="Límite POS por defecto")
    created_at: str = Field(..., description="Fecha de creación")
    created_by: str = Field(..., description="Creado por")
    updated_at: str = Field(..., description="Fecha de actualización")
    updated_by: Optional[str] = Field(default=None, description="Actualizado por")
...
class RateTypeEmbedded(BaseModel):
    ...
    occupancy_pricing_by_type: bool = Field(..., description="Precio por ocupación por tipo")
    ...
    updated_by: Optional[str] = Field(default=None, description="Actualizado por")
    updated_at: Optional[str] = Field(default=None, description="Fecha de actualización")
    parent_rate_id: Optional[int] = Field(default=None, description="ID de tarifa padre")
    ...
    min_los_type: Optional[str] = Field(default=None, description="Tipo de estadía mínima")
    min_los_amount: Optional[float] = Field(default=None, description="Cantidad de estadía mínima")
    max_los_type: Optional[str] = Field(default=None, description="Tipo de estadía máxima")
    max_los_amount: Optional[float] = Field(default=None, description="Cantidad de estadía máxima")
